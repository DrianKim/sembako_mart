...
<head>
    ...
    <title>@yield('title', 'Dashboard Kasir') - Sembako Mart</title>
...
<body class="font-sans bg-gray-50">
            ...
            <div
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600">Kasir Panel</p>
                    </div>
                </div>
                <!-- Mobile Close Button -->
            ...
            <nav class="flex-1 px-4 py-6 overflow-x-hidden overflow-y-auto">
                <div class="space-y-2">
                    ...
                    <a href="{{ route('kasir.dashboard') }}"
                        class="flex items-center px-4 py-3 text-gray-700 rounded-lg nav-item {{ request()->routeIs('kasir.dashboard') ? 'nav-item-active' : '' }}">
                        <svg class="w-5 h-5 mr-3 {{ request()->routeIs('kasir.dashboard') ? 'text-green-600' : 'text-gray-500' }}"
                    ...
                    <a href="{{ route('kasir.transaksi') }}"
                        class="flex items-center px-4 py-3 text-gray-700 rounded-lg nav-item {{ request()->routeIs('kasir.transaksi') ? 'nav-item-active' : '' }}">
                        <svg class="w-5 h-5 mr-3 {{ request()->routeIs('kasir.transaksi') ? 'text-green-600' : 'text-gray-500' }}"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="flex items-center justify-between h-20 px-6">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="hidden md:block">
                            <h2 class="text-2xl font-bold text-gray-800">@yield('title', 'Dashboard Kasir')</h2>
                            <p class="text-sm text-gray-600">@yield('page-description', 'Selamat datang di panel kasir Sembako Mart')</p>
                        </div>
                    </div>

                    <!-- Right Section -->
                    <div class="flex items-center space-x-4">
                        <!-- Notifications (dummy, sama seperti admin) -->
                        <div class="relative">
                                ...
                                <div class="overflow-y-auto max-h-96">
                                    <a href="#" class="flex items-start p-4 transition-colors hover:bg-gray-50">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-xs text-gray-600">Beras stok tinggal sedikit</p>
                                            <p class="mt-1 text-xs text-gray-400">Baru saja</p>
                                        </div>
                                    </a>
                                </div>
                        ...
                        <!-- User Profile (sama seperti admin) -->
                        <div class="relative">
    ...
    <!-- Scripts (sama persis seperti admin) -->
    <script>
        // Mobile Menu Toggle
        ...
        // SweetAlert Logout (sama persis)
        function handleLogout() {
            Swal.fire({
                title: 'Yakin mau logout?',
                text: "Kamu akan keluar dari sesi kasir.",
                icon: 'question',
