    ...
    <div class="overflow-hidden bg-white border border-gray-200 rounded-lg shadow-sm">
        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-green-50 to-white">
            <div class="flex items-center">
                ...
                <div>
                    <h3 class="text-xl font-bold text-gray-800">Edit Stok: Beras Pandan Premium 5kg</h3>
                    <p class="text-sm text-gray-600">Kode: BRP-001 | Satuan: Kg</p>
                </div>
            </div>
        </div>

        <form action="#" method="POST" id="formStokEdit">
            @csrf
            @method('PUT')
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" value="Beras Pandan Premium 5kg"
                    ...
                    <div class="md:col-span-2">
                        <label for="stok" class="block mb-2 text-sm font-semibold text-gray-700">
                            <i class="mr-1 text-green-600 fas fa-edit"></i>
                ...
                <div class="p-4 mt-8 border-l-4 border-green-500 rounded bg-green-50">
                    <p class="text-sm text-green-800">
                        ...
                        Mengedit stok akan mengganti nilai stok saat ini sepenuhnya.
                    </p>
                </div>
            </div>
