...
@else
    <a href="#" data-page="{{ $logs->currentPage() - 1 }}"
...
@foreach ($logs->getUrlRange(1, $logs->lastPage()) as $page => $url)
    <a href="#" data-page="{{ $page }}"
        ...
        {{ $page == $logs->currentPage() ? 'text-white bg-green-600 border-green-600 hover:bg-green-700' : 'text-gray-700 bg-white border-gray-300 hover:bg-gray-50' }}">
        {{ $page }}
    </a>
@endforeach
