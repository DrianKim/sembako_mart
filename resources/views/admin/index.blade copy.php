            ...
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200" id="tableBody">
                    ...
                    <tr class="transition-colors hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex items-center justify-center flex-shrink-0 w-10 h-10 mr-3 bg-green-100 rounded-lg">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900">Produk beras, tepung, dan hasil olahan</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <tr class="transition-colors hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex items-center justify-center flex-shrink-0 w-10 h-10 mr-3 bg-orange-100 rounded-lg">
                        ...
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900">Minyak goreng, mentega, margarin</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-3 py-1 text-sm font-semibold text-green-700 bg-green-100 rounded-full">
                                18 Produk
                    ...
                    <tr class="transition-colors hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <div class="text-sm font-semibold text-gray-900">Gula & Pemanis</div>
                                    <div class="text-xs text-gray-500">Kode: KTG-003</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900">Gula pasir, gula merah, pemanis</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-3 py-1 text-sm font-semibold text-green-700 bg-green-100 rounded-full">
                                12 Produk
...
@push('scripts')
    <script>
        ...
        document.getElementById('btnTambah').addEventListener('click', function() {
            alert('Fitur Tambah Kategori akan segera ditambahkan!');
        });
