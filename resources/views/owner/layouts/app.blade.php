        ...
        <aside id="sidebar"
            ...
            <div
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600">Owner Panel</p>
                    </div>
                </div>
                <!-- Mobile Close Button -->
            ...
            <nav class="flex-1 px-4 py-6 overflow-x-hidden overflow-y-auto">
                <div class="space-y-2">
                    ...
                    <!-- Divider -->
                    <div class="pt-4 pb-2">
                        <p class="px-4 text-xs font-semibold tracking-wider text-gray-400 uppercase">Manajemen</p>
                    </div>
                    ...
                    {{-- <a href="{{ route('owner.riwayat_transaksi') }}"
                       class="flex items-center px-4 py-3 text-gray-700 rounded-lg nav-item {{ request()->routeIs('owner.riwayat_transaksi*') ? 'nav-item-active' : '' }}">
                        <svg class="w-5 h-5 mr-3 {{ request()->routeIs('owner.riwayat_transaksi*') ? 'text-green-600' : 'text-gray-500' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex items-center justify-between h-20 px-6">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="hidden md:block">
                            ...
                            <p class="text-sm text-gray-600">@yield('page-description', 'Selamat datang di panel owner Sembako Mart')</p>
                        </div>
                    </div>
                            ...
                            <div id="notification-dropdown"
                                ...
                                <div class="overflow-y-auto max-h-96">
                                    ...
                                    <a href="#" class="flex items-start p-4 transition-colors hover:bg-gray-50">
                                        ...
                                        <div class="flex-1">
                                            <p class="text-sm font-semibold text-gray-800">Penjualan Bulan Ini Naik</p>
                                            <p class="text-xs text-gray-600">Omzet naik 18% dibanding bulan lalu</p>
    ...
    <script>
        ...
        function handleLogout() {
            Swal.fire({
                ...
                text: "Kamu akan keluar dari sesi owner.",
                icon: 'question',
