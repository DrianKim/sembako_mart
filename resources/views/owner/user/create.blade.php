...
@section('page-description', 'Form untuk menambah data admin/kasir baru.')
    ...
    <nav class="flex mb-6" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <i class="w-6 h-6 text-gray-400 fas fa-chevron-right"></i>
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Tambah User Baru</span>
                </div>
            </li>
        </ol>
    </nav>
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-green-50 to-white">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">Isi form di bawah untuk menambah data admin/kasir baru</p>
                </div>
            </div>
        </div>

        <form action="{{ route('owner.user.store') }}" method="POST" id="formUser">
            @csrf
