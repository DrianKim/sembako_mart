...
@else
    <a href="#" data-page="{{ $users->currentPage() - 1 }}"
...
@foreach ($users->getUrlRange(1, $users->lastPage()) as $page => $url)
    <a href="#" data-page="{{ $page }}"
        ...
        {{ $page == $users->currentPage() ? 'text-white bg-green-600 border-green-600 hover:bg-green-700' : 'text-gray-700 bg-white border-gray-300 hover:bg-gray-50' }}">
        {{ $page }}
    </a>
@endforeach
